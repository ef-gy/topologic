...
JSFUNCTIONS:=['_main','_setConstant','_setPrecision','_updateModel','_updateProjection','_interpretDrag','_setActiveDimension','_forceRedraw','_setIFSParameters','_setFlameColouring','_setColour','_setFlameParameters','_resetColourMap','_setViewportSize','_getJSON','_getSVG','_parseJSON','_getModels']
